...
- [ ] گزارش فروش/تخفیف — استپ ۸ (تخفیف)، آینده (فروش تفصیلی)
...
- [x] استپ ۱۲ — ویرایشگر بصری دکمه‌ها (Visual Button Flow) — جایگزین سیستم دکمهٔ تخت
  ...
  - [ ] فاز ۸ — Undo/Redo (Ctrl+Z) + UI تاریخچهٔ نسخه‌ها برای rollback
    ...
    - [ ] نمایش تعداد نود/تاریخ/یادداشت هر نسخه
  - [ ] فاز ۹ — محافظت کامل دکمه‌های سیستمی + تأییدیه‌های حذف/ویرایش
    - [ ] علامت‌گذاری همهٔ دکمه‌های هستهٔ ربات (منوی اصلی تا پنل ادمین) به‌عنوان سیستمی
    - [ ] تأییدیهٔ دو‌مرحله‌ای ویرایش/حذف نود سیستمی (نه مستقیم)
    - [ ] حذف صفحهٔ موقت دیباگ `panel/diag.php?flowtest` بعد از تأیید نهایی کاربر
