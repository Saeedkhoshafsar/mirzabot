...
⚠️ 此部分用于无需审核的自动批准',
                        ...
                        'btn_27' => '人员列表👇',
                        'msg_panel_admin_bot_report' => '🤖 | 欢迎来到管理面板',
...
用户用户名：@%s',
        ...
        'panel' => [
          ...
          捐赠',
                ...
                'productDurationLabel' => '时长（天）',
                'productCloseBtn' => '高级代理',
                'productColPrice' => '价格',
                'productTypeAgentPro' => '高级代理',
                'productCancelModalBtn' => '取消',
                'productNoteLabel' => '说明',
                'productTypeLabel' => '代理',
                'productTypeAgent' => '代理',
                'productEmptyState' => '您尚未登记任何产品',
                'productSaveSubmitBtn' => '保存产品',
                'productColName' => '产品名称',
                'productListTitle' => '产品列表',
                'productTypeRegular' => '普通用户',
                'productEmptyAddBtn' => '添加
        第一个产品',
