...
⚠️ This section is for automatic approval without review',
                        ...
                        'msg_panel_admin_bot_report' => '🤖 | Welcome to the admin panel',
...
User username : @%s',
        ...
        'panel' => [
          ...
          donate',
                ...
                'productColPanel' => 'Panel',
                'productAddedPrefix' => 'Product «',
                'productAddedSuffix' => '» was added.',
                'productDurationLabel' => 'Duration (days)',
                'productCloseBtn' => 'Advanced agent',
                'productColPrice' => 'Price',
                'productTypeAgentPro' => 'Advanced agent',
                'productCancelModalBtn' => 'Cancel',
                'productNoteLabel' => 'Description',
                'productTypeLabel' => 'Agency',
                'productTypeAgent' => 'Agent',
                'productEmptyState' => 'You have not registered any product yet',
                'productSaveSubmitBtn' => 'Save product',
                'productColName' => 'Product name',
                'productListTitle' => 'Products list',
                'productTypeRegular' => 'Regular user',
                'productEmptyAddBtn' => 'Add
        the first product',
                ...
                'productPanelLabel' => 'Panel',
                'productNameLabel' => 'Product name *',
                'productCategoryLabel' => 'Category',
                'productNotSelected' => '— Not selected —',
                'productDurationUnit' => 'day',
                'productColCode' => 'Code',
                'productAddModalTitle' => 'Add new product',
                'productPriceUnit' => 'T',
                'productColActions' => 'Operation',
                ...
                'productColVolume' => 'Volume',
                'productColDuration' => 'Duration',
                'productPriceLabel' => 'Price (Toman)',
